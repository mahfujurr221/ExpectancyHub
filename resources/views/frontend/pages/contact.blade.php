                ...
                <div class="row pb---96">
                    <div class="col-lg-4 pt---10">
                        <ul class="address-sec">
                            <li>
                                <em class="icon"><img src="{{ asset('frontend/images/contact/2.png') }}"
                                        alt="image"></em>
                                <span class="text"><em>Address</em> {{ setting()->address }}</span>
                            </li>
                            <li>
                                <em class="icon"><img src="{{ asset('frontend/images/contact/3.png') }} "
                                        alt="image"></em>
                                <span class="text"><em>Contact</em> <a href="#">Mobile:
                                        (+88){{ setting()->phone }}</a>
                                    <a href="#">Mail: {{ setting()->email }}</a></span>
                            </li>
                            <li>
                                <em class="icon"><img src="{{ asset('frontend/images/contact/4.png') }} "
                                        alt="image"></em>
                            ...
                            <div id="blog-form" class="blog-form">
                                ...
                                <form id="contact-form">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <button type="submit" class="back-btn">Send Message <svg width="24"
                    ...
                    <div class="react-contacts pt-106">
                        <div class="react-image-maping">
                            ...
                            <div class="react-ripple react-tooltip1">
                                <div class="box"><span>Dhaka</span></div>
                            </div>
                        </div>
                    </div>
