    ...
    <div class="row gx-0 align-items-center">
        ...
        <div class="mb-2 text-center col-lg-3 row-cols-1 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <a class="btn btn-sm btn-outline-light btn-square rounded-circle me-2" href="{{setting()->facebook}}"><i
                        class="fab fa-facebook-f fw-normal text-secondary"></i></a>
                <a class="btn btn-sm btn-outline-light btn-square rounded-circle me-2" href="{{setting()->linkedin}}"><i
                        class="fab fa-linkedin-in fw-normal text-secondary"></i></a>
                <a class="btn btn-sm btn-outline-light btn-square rounded-circle me-2"
                    href="{{setting()->instagram}}"><i class="fab fa-instagram fw-normal text-secondary"></i></a>
                <a class="btn btn-sm btn-outline-light btn-square rounded-circle" href="{{setting()->youtube}}"><i
...
<div class="p-0 container-fluid nav-bar">
    <nav class="px-4 py-3 bg-white navbar navbar-expand-lg navbar-light px-lg-5 py-lg-0">
        <a href="" class="p-0 navbar-brand">
            {{-- <h1 class="m-0 display-5 text-secondary"><img src="img/brand-logo.png" class="img-fluid"
                    alt="">Expectancy Hub</h1> --}}
            <img src="{{ asset('/uploads/' . setting()->logo) }}" alt="Logo" width="250" class="img-fluid">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <button class="mb-3 btn btn-primary btn-md-square border-secondary mb-md-3 mb-lg-0 me-3"
                data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fas fa-search"></i></button>
            {{-- <a href=""
                class="px-4 py-2 mb-3 btn btn-primary border-secondary rounded-pill px-lg-3 mb-md-3 mb-lg-0">Get A
                Quote</a> --}}
        </div>
    </nav>
</div>
