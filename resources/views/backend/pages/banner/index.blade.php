...
@section('content')
    ...
    <x-modal id="addBannerModal" title="Add New Banner" modalSize="modal-lg" action="{{ route('banners.store') }}">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-2 form-group">
                    ...
                    <x-input type="text" name="videoText" placeholder="Video Text" required />
                </div>
        ...
        <div class="mb-2 form-group">
            ...
            <x-input type="text" name="btnUrl" placeholder="Video Text" required />
        </div>

        <div class="mb-2 form-group">
            <label class="form-label" for="videoUrl"> Video Embed Code <span class="text-danger">*</span></label>
            <x-input type="text" name="videoUrl" placeholder="Video embed code" required />
        </div>
    ...
    <x-modal id="editBannerModal" title="Update Banner" modalSize="modal-lg" method="POST" encytpe="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-2 form-group">
                    ...
                    " for="buttonText"> Button Text</label>
            ...
            <div class="col-md-6">
                <div class="mb-2 form-group">
                    <label class="form-label
                    " for="videoText"> Video Text</label>
        ...
        <div class="mb-2 form-group">
            <label class="form-label" for="buttonText"> Button Url <span class="text-danger">*</span></label>
            <x-input type="text" name="btnUrl" placeholder="Video Text" id="edit_btnUrl" required />
        </div>

        <div class="mb-2 form-group">
            <label class="form-label" for="videoUrl"> Video Embed Code <span class="text-danger">*</span></label>
            <x-input type="text" name="videoUrl" placeholder="Video embed code" id="edit_videoUrl" required />
        </div>

        <div class="mb-2 form-group">
            <label class="form-label" for="image">Image <span class="text-danger">*</span></label>
            <x-input type="file" name="image_url"  class="mb-1 form-group"/>
