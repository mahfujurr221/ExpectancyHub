    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('countries.*') ? '' : 'collapsed' }}" data-bs-target="#countries-nav"
                data-bs-toggle="collapse" href="#">
                <i class="bi bi-flag-fill"></i><span>Countries</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            ...
            <ul id="services-nav"
                ...
                <li>
                    <a href="{{ route('services.create') }}"
                        class="{{ Route::currentRouteName() == 'services.create' ? 'active nav-link' : '' }}">
                ...
                <li>
                    <a href="{{ route('services.index') }}"
                        class="{{ Route::currentRouteName() == 'services.index' ? 'active nav-link' : '' }}">
                        <i class="bi bi-circle"></i><span>Service List</span>
                    </a>
                </li>
                @endcan

                @can('create-sub-service')
                <li>
                    <a href="{{ route('sub-services.create') }}"
                        class="{{ Route::currentRouteName() == 'sub-services.create' ? 'active nav-link' : '' }}">
                        <i class="bi bi-circle"></i><span>Add Subservice</span>
                    </a>
                </li>
                @endcan

                @can('list-sub-service')
                <li>
                    <a href="{{ route('sub-services.index') }}"
                        class="{{ Route::currentRouteName() == 'sub-services.index' ? 'active nav-link' : '' }}">
                        <i class="bi bi-circle"></i><span>Subservice List</span>
                    </a>
                </li>
                @endcan
